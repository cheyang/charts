...
| `Resources.limits.cpu`            | container requested cpu            | `100m`                                                            |
| `Resources.limits.memory`         | container requested memory         | `512Mi`                                                           |
| `Resources.limits.nvidia/gpu`         | container requested gpu         | `1`                                                           |
